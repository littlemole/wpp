...
rem cmake --install . --prefix "%~dp0\..\out\build\x64-Debug\vcpkg_installed\x64-windows"
...
rem cmake --install . --prefix "%~dp0\..\out\build\x64-Release\vcpkg_installed\x64-windows"
